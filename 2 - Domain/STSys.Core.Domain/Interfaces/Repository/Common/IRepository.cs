...
namespace STSys.Core.Domain.Interfaces.Repository
{
    public interface IRepository<TEntity> where TEntity : class
    {
        ...
        TEntity Find(string sql, object predicate = null, IDbTransaction transaction = null);
        Task<TEntity> FindAsync(string sql, object predicate = null, IDbTransaction transaction = null);
        ...
        dynamic Insert(TEntity entity, CommittableTransaction transaction);
        ...
        int Update(Expression<Func<TEntity>> expression, Expression<Func<TEntity, bool>> where, IDbTransaction transaction = null);
        ...
        Task<dynamic> InsertAsync(TEntity entity, IDbTransaction transaction = null);
        ...
        PageDataView<TEntity> GetPage(PageCriteria criteria, object param = null, IDbTransaction transaction = null);
        TEntity First(Expression<Func<TEntity, bool>> where, IDbTransaction transaction = null);
        int Delete(Expression<Func<TEntity, bool>> where, IDbTransaction transaction = null);
    }
}
