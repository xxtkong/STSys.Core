//引用基础css js
document.write("<script type='text/javascript' language='javascript' src='/lib/layer-v3.0.3/layer/layer.js'></script>"); //消息提示
...
var lay = new function () {
    ...
    this.confirm = function (msg, title, icon, yesback, cancelback) {
        if (title == null || title == "undefined" || title == "") {
            title = "提示";
        }
        layer.confirm(msg, {
