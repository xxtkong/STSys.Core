    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:102%;' +
        ...
        bind: function () {
            ...
            this.$dropdown.on('click', '.city-select a', function () {
                var c = $(".city-select-tab a.active").data('count');
                ...
                $this.options.callback($(this).attr('title'), c);
        ...
        getList: function (data, type) {
            var list = [],
                $this = this,
                simple = this.options.simple;
            list.push('<dl class="clearfix1"><dd>');
