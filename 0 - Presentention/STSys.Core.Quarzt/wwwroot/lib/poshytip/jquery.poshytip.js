		...
		refresh: function(async) {
			...
			if (bgImage) {
				...
				if (ie6 && bgImagePNG) {
				    ...
				    this.$tip.prepend('<table class="tip-table" border="0" cellpadding="0" cellspacing="0" style="border: initial;"><tr><td class="tip-top tip-bg-image" colspan="2" style="height:initial;border: initial;"><span></span></td><td class="tip-right tip-bg-image" rowspan="2" style="height:initial;border: initial;"><span></span></td></tr><tr><td class="tip-left tip-bg-image" rowspan="2"  style="height:initial;border: initial;"><span></span></td><td  style="height:initial;border: initial;"></td></tr><tr><td class="tip-bottom tip-bg-image" colspan="2"  style="height:initial;border: initial;"><span></span></td></tr></table>')
